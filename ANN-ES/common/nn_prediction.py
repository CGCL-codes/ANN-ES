...
import utils
from common.zeshel_utils import WORLDS, Stats
...
def get_topk_predictions_1(
    ...
    for step, batch in enumerate(iter_):
        ...
        for i in range(context_input.size(0)):
            ...
            # add examples in new_data
            cur_candidates = candidate_pool[src][inds.cpu().detach().numpy()]
            nn_context.append(context_input[i].cpu().tolist())
